<script type="text/javascript">
    ...
    var CHRONORELAIS_AMBIENT_ID = "{$CHRONORELAIS_AMBIENT_ID|escape:'javascript':'UTF-8'}";
    var CHRONORELAIS_AMBIENT_ID_INT = "{$CHRONORELAIS_AMBIENT_ID_INT|escape:'javascript':'UTF-8'}";
    ...
    var TOSHOPDIRECT_ID = "{$TOSHOPDIRECT_ID|escape:'javascript':'UTF-8'}";
    var TOSHOPDIRECT_ID_INT = "{$TOSHOPDIRECT_ID_INT|escape:'javascript':'UTF-8'}";
</script>
