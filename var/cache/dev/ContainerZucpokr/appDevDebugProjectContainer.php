...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('wrstUvBUMX', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('um1BgbmFPo', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'hmdb', 'user' => 'hmuser', 'password' => 'tKTvrMB4', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setNamingStrategy(${($_ = isset($this->services['prestashop.database.naming_strategy']) ? $this->services['prestashop.database.naming_strategy'] : ($this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('hmps'))) && false ?: '_'});
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('hmps');
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qnwHU9Io3-', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uNwD6JVqzy', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('brWM0emoXZcrnMwHQwL5WgSFSX9hyWIow3m1ztNwF7K8e1wcg5t0SevjvyMrSKkr'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('brWM0emoXZcrnMwHQwL5WgSFSX9hyWIow3m1ztNwF7K8e1wcg5t0SevjvyMrSKkr');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                22 => ($this->targetDirs[3].'/modules/ps_searchbar/translations'),
                23 => ($this->targetDirs[3].'/modules/ps_shoppingcart/translations'),
                24 => ($this->targetDirs[3].'/modules/ps_socialfollow/translations'),
                25 => ($this->targetDirs[3].'/modules/ps_themecusto/translations'),
                26 => ($this->targetDirs[3].'/modules/ps_wirepayment/translations'),
                27 => ($this->targetDirs[3].'/modules/statsbestcategories/translations'),
                28 => ($this->targetDirs[3].'/modules/statsbestcustomers/translations'),
                29 => ($this->targetDirs[3].'/modules/statsbestproducts/translations'),
                30 => ($this->targetDirs[3].'/modules/statsbestsuppliers/translations'),
                31 => ($this->targetDirs[3].'/modules/statsbestvouchers/translations'),
                32 => ($this->targetDirs[3].'/modules/statscarrier/translations'),
                33 => ($this->targetDirs[3].'/modules/statscatalog/translations'),
                34 => ($this->targetDirs[3].'/modules/statscheckup/translations'),
                35 => ($this->targetDirs[3].'/modules/statsdata/translations'),
                36 => ($this->targetDirs[3].'/modules/statsforecast/translations'),
                37 => ($this->targetDirs[3].'/modules/statsnewsletter/translations'),
                38 => ($this->targetDirs[3].'/modules/statspersonalinfos/translations'),
                39 => ($this->targetDirs[3].'/modules/statsproduct/translations'),
                40 => ($this->targetDirs[3].'/modules/statsregistrations/translations'),
                41 => ($this->targetDirs[3].'/modules/statssales/translations'),
                42 => ($this->targetDirs[3].'/modules/statssearch/translations'),
                43 => ($this->targetDirs[3].'/modules/statsstock/translations'),
                44 => ($this->targetDirs[3].'/modules/blockreassurance/translations'),
                45 => ($this->targetDirs[3].'/modules/ps_newproducts/translations'),
                46 => ($this->targetDirs[3].'/modules/ps_categorytree/translations'),
                47 => ($this->targetDirs[3].'/modules/ps_mainmenu/translations'),
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.secret' => 'brWM0emoXZcrnMwHQwL5WgSFSX9hyWIow3m1ztNwF7K8e1wcg5t0SevjvyMrSKkr',
